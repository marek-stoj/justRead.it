...
using JustReadIt.WebApp.Areas.Feedbin.Core.Models.Entries;
...
namespace JustReadIt.WebApp.Areas.Feedbin.Core.Controllers {
  ...
  public class EntriesController : FeedbinApiController {
    ...
    /// </remarks>
    [HttpGet]
    public IEnumerable<Entry> GetAll(int? per_page = null, int? page = null, string since = null, bool? read = null, bool? starred = null, string ids = null) {
